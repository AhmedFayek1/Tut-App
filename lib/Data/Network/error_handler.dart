...
class ResponseMessages {
  static String SUCCESS = StringsManager.success.tr();// OK
  static String NO_CONTENT = StringsManager.noContent.tr(); // NO CONTENT
  static String BAD_REQUEST = StringsManager.badRequest.tr(); // BAD REQUEST
  static String UNAUTHORIZED = StringsManager.unauthorized.tr(); // UNAUTHORIZED
  static String FORBIDDEN = StringsManager.forbidden.tr(); // FORBIDDEN
  static String NOT_FOUND = StringsManager.notFound.tr(); // NOT FOUND
  static String INTERNAL_SERVER_ERROR = StringsManager.internalServerError.tr(); // INTERNAL SERVER ERROR
  static String SERVICE_UNAVAILABLE = StringsManager.serviceUnavailable.tr(); // SERVICE UNAVAILABLE
  static String BAD_GATEWAY = StringsManager.badGateway.tr(); // BAD GATEWAY

  static String CONNECTION_TIMEOUT = StringsManager.connectionTimeout.tr(); // CONNECTION TIMEOUT
  static String DEFAULT = StringsManager.defaultError.tr(); // UNKNOWN ERROR
  static String CANCELLED = StringsManager.cancelled.tr();
  static String NO_INTERNET = StringsManager.noInternet.tr();
  static String REICEVE_TIMEOUT = StringsManager.receiveTimeout.tr();
  static String SEND_TIMEOUT = StringsManager.sendTimeout.tr();
  static String CACHE_TIMEOUT = StringsManager.cacheTimeout.tr();
}
